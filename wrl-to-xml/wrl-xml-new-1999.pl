...
#     -	Try using the current hnum if the current entry is the verhw we
#	are looking for (definitions often <CT> themselves!)
#     - Find out why yarri isn't getting a gloss, even though the words that
#	XME from it have them.
