...
<xsl:template match="/">
<xsl:text>\documentclass[12pt,twocolumn]{book}
\usepackage{wrldictbare}
...
<xsl:template match="DEF">
  <xsl:text>\df{</xsl:text><xsl:apply-templates/>
  <xsl:text>}</xsl:text>
</xsl:template>
...
<xsl:template match="ET">
  <xsl:text>\et{</xsl:text><xsl:apply-templates/><xsl:text>}</xsl:text>
</xsl:template>
...
<xsl:template match="GL">
  <xsl:text>\gl{</xsl:text><xsl:apply-templates/>
  <xsl:text>}</xsl:text>
</xsl:template>


<xsl:template match="GLI">
  <xsl:text>\gli{</xsl:text><xsl:apply-templates/>
  <xsl:text>}</xsl:text>
</xsl:template>
